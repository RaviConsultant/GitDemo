...
namespace Assignment_oops_sol_2_1
{
    ...
    internal class Program
    {
        ...
        {
            IAccount Iacc = new IAccount();
            Account acc = new Account();
            acc.currentbalance = 1000;
            int p = 0;
            Console.WriteLine("Type 1 for Savings acc:");
            Console.WriteLine("Type 2 for Current acc:");
            Console.WriteLine("Type 3 for FD acc:");
            Console.WriteLine("Type 4 for RD acc:");
