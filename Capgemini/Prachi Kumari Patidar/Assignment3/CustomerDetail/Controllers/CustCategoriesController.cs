...
namespace CustomerDetail.Controllers
{
    public class CustCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CatName")] CustCategory custCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CatName")] CustCategory custCategory)
        {
            if (ModelState.IsValid)
            {
