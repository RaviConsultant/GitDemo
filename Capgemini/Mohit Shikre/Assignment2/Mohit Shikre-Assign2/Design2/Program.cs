...
namespace IBank_Design2
{
    internal class Program
    {
        ...
        public class SB_Account : Account, IAccount// implementing multiple inheritance in SB_Account class
        {
        ...
        public class Current_Account : Account, IAccount// implementing multiple inheritance in Current_Account class
        {
        ...
        public class FD_Account : Account, IAccount// implementing multiple inheritance in FD_Account class
        {
        ...
        {  //example of implementing of type Saving Bank account
